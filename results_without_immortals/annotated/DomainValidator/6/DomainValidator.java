...
public class DomainValidator implements Serializable {
    ...
    public static synchronized DomainValidator getInstance() {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "ffe398ad-cd8d-4823-ae4c-ebabed64eaab");
        inUse = true;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "60fe0885-dedc-4dea-8bf6-c8c1605d5007");
    ...
    public static synchronized DomainValidator getInstance(boolean allowLocal) {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "0836abe0-06e2-47e7-8720-9762beadedbc");
        inUse = true;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "63b39fa0-8c5c-4f78-bf1c-26f46e880094");
        if (allowLocal) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "390ebef1-512a-4cdc-a9f6-1fff4db82b81");
            return DOMAIN_VALIDATOR_WITH_LOCAL;
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "17698777-3dde-46bc-b2b9-b5801092d247");
        return DOMAIN_VALIDATOR;
    }
    ...
    public boolean isValid(String domain) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "6c58068a-26a1-44ba-9d9e-168de8bb2fd0");
        if (domain == null) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "c9774686-dedd-46dc-980b-b3cb1c045a1a");
            return false;
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "770ec7b4-0185-4719-9954-04709a84b549");
        domain = unicodeToASCII(domain);
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "aa14d360-0dce-486a-bf57-dabfaf64b554");
        // checks in the regexes below
        if (domain.length() > 253) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "d0291f62-ede1-4209-bc65-2b4a0ccc788e");
            return false;
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "c84bfae8-7e82-4ac9-a69f-2c582c29fda9");
        String[] groups = domainRegex.match(domain);
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "296c5442-b001-4652-862c-5c9063c61862");
        if (groups != null && groups.length > 0) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "d06e9ff0-f45b-4f25-8268-3ee3a0453c5d");
            return isValidTld(groups[0]);
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "6fd72555-92e0-48d7-85bf-52d77635b586");
    ...
    final boolean isValidDomainSyntax(String domain) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "a84f20f0-a2a2-47d2-b96f-0f70f8791db8");
        if (domain == null) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "594c960e-e3a4-4bcd-b062-cff3f1ac278e");
            return false;
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "e2af00c6-bc6f-4a6d-a0ce-afc576ca8d0b");
        domain = unicodeToASCII(domain);
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "033f55e8-390d-424d-b67e-0e0c07fa07b8");
        // checks in the regexes below
        if (domain.length() > 253) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "353c6f20-fe74-468d-bc21-523e596a3d15");
            return false;
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "8aa33a28-f1db-4625-871b-ec1675c7f474");
        String[] groups = domainRegex.match(domain);
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "66853dc9-4a7a-4798-81a6-f759aeffcb90");
    ...
    public boolean isValidTld(String tld) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "9ca65647-396d-44bc-aa2d-adbd4dc74d23");
        tld = unicodeToASCII(tld);
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "d5f2f99e-11bc-40c0-9e07-e97aad481817");
        if (allowLocal && isValidLocalTld(tld)) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "1f868449-b8e8-4b89-b9aa-ac9d37183429");
            return true;
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "2de2f9ae-a452-4bd2-9c4e-36e24818607e");
    ...
    public boolean isValidInfrastructureTld(String iTld) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "b69155fa-4035-4e90-ae45-de4e398c6149");
        final String key = chompLeadingDot(unicodeToASCII(iTld).toLowerCase(Locale.ENGLISH));
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "ed92d71c-f5e5-4119-9890-6e1701683357");
    ...
    public boolean isValidGenericTld(String gTld) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "47d18d25-fec0-41e2-836f-18378fff49cb");
        final String key = chompLeadingDot(unicodeToASCII(gTld).toLowerCase(Locale.ENGLISH));
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "dacfce25-54c0-48bf-9de4-c2930827640e");
    ...
    public boolean isValidCountryCodeTld(String ccTld) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "1acc48ad-7d21-474a-810f-22676c7fb682");
        final String key = chompLeadingDot(unicodeToASCII(ccTld).toLowerCase(Locale.ENGLISH));
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "2ac523f5-31c1-4365-9497-ed74d2764ae2");
    ...
    public boolean isValidLocalTld(String lTld) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "f737e9ba-bb3b-4562-8442-b06d7b41992c");
        final String key = chompLeadingDot(unicodeToASCII(lTld).toLowerCase(Locale.ENGLISH));
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "e877fc4f-623f-411a-ada9-5a23cfcb7f27");
        return arrayContains(LOCAL_TLDS, key);
    }

    private String chompLeadingDot(String str) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "d10d3d17-eac3-41fe-a706-6444b1d9befd");
        if (str.startsWith(".")) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "f37ca0d9-0d22-4b78-b5a4-0e66e690bc17");
            return str.substring(1);
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "055b535d-0bff-435b-8338-5aa6e6a0b490");
        return str;
    }
    ...
    static synchronized void clearTLDOverrides() {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "33505ebb-9dfa-410b-8761-7444441e08b5");
        inUse = false;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "74e125ff-b5c5-4d75-9079-61da517fb371");
        COUNTRY_CODE_TLDS_PLUS = EMPTY_STRING_ARRAY;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "5d528488-0451-4858-826d-f778dbed9aa1");
        COUNTRY_CODE_TLDS_MINUS = EMPTY_STRING_ARRAY;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "c3c0cb30-5314-45c5-804e-051885113391");
        GENERIC_TLDS_PLUS = EMPTY_STRING_ARRAY;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "3669f45f-b027-4e7e-ab97-402bd48275d4");
    ...
    public static synchronized void updateTLDOverride(ArrayType table, String[] tlds) {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "3f23f1b0-55c4-494f-8a02-fd10902c78ca");
        if (inUse) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "ddaa82fe-0065-454f-91f2-494a8995201b");
            throw new IllegalStateException("Can only invoke this method before calling getInstance");
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "47631896-0280-4d58-ac4d-1f5be1a23fae");
        String[] copy = new String[tlds.length];
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "e1d82b82-ceac-4336-a30b-38c6459b36a7");
        // Comparisons are always done with lower-case entries
        for (int i = 0; i < tlds.length; i++) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "1693f5aa-cd1d-4381-b8ff-8f42657a028a");
            copy[i] = tlds[i].toLowerCase(Locale.ENGLISH);
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "32b079c1-9bca-4637-adb5-4d350d9ab6ef");
        Arrays.sort(copy);
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "2edffe06-6ae1-47a9-a718-03c0c5cba6e6");
        switch(table) {
            case COUNTRY_CODE_MINUS:
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "69eb35be-5de1-4fff-b425-f710edc1a560");
                COUNTRY_CODE_TLDS_MINUS = copy;
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "95186746-6bb6-4a81-9c8f-8d3a5bbb3dc6");
                break;
            case COUNTRY_CODE_PLUS:
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "41c1f315-a9da-4d97-b624-3ed61d09b69b");
                COUNTRY_CODE_TLDS_PLUS = copy;
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "07542c13-92b5-480f-92a6-a77089a6049a");
                break;
            case GENERIC_MINUS:
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "892bc6da-925b-4a38-9e42-6fa5c5de77f2");
                GENERIC_TLDS_MINUS = copy;
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "601c6e6e-c007-4480-8bb4-7c7727d2f77a");
                break;
            case GENERIC_PLUS:
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "6bad3503-90e3-4637-a8cb-dd342f5d3ed0");
                GENERIC_TLDS_PLUS = copy;
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "0deffb04-4c8b-487c-a641-3ad5d61944f7");
                break;
        }
    }
    ...
    static String unicodeToASCII(String input) {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "aa86cc44-718e-4e6f-bf29-bc8de3f1f190");
        String returnValue = "";
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "4424dc45-be06-48a7-b001-ad0a46d4eb49");
        if (isOnlyASCII(input)) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "30d70655-7bcd-4101-b445-e8abc2c79477");
            // skip possibly expensive processing
            return input;
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "d0c18001-cad2-4ad2-aad5-e60d6e843ec0");
        try {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "b1d4b76c-360d-4711-b09f-dd4eb8aafecb");
            final String ascii = IDN.toASCII(input);
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "86ae6bbd-58d9-43e3-a0dc-d3fd0fcfd157");
            if (IDNBUGHOLDER.IDN_TOASCII_PRESERVES_TRAILING_DOTS) {
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "d54e8a63-ac36-407e-9e30-140ec52bc7f2");
                return ascii;
            }
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "a5d1cff0-73c7-42ed-94fe-259c6050b338");
            final int length = input.length();
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "5798c6c6-9435-4bd6-b017-e311c5ec8c5a");
            if (length == 0) {
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "07935a4a-d4b3-45c1-9abe-b3f7d9a3253c");
                // check there is a last character
                return input;
            }
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "476b0c4f-0151-49a2-a0f5-119fa12756cd");
            // RFC3490 3.1. 1)
            ...
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "11844267-978d-47ca-abda-57e358f2dfb3");
            switch(lastChar) {
                case '\u002E':
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "35db09a2-d158-4e8a-b554-93394fe0f798");
                    returnValue = ascii + ".";
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "4f4977f7-a69b-4461-9789-58c86ed615a1");
                    // "." full stop
                    break;
                case '\u3002':
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "29835003-2a6c-4a29-a9b8-6445cf0fcc6c");
                    returnValue = ascii + ".";
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "90a0a014-79a8-407a-9895-df265e481827");
                    // ideographic full stop
                    break;
                case '\uFF0E':
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "9dcdf6dd-91a2-442a-b81f-215b7e8bbb54");
                    returnValue = ascii + ".";
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "4d525d15-12dc-4cf6-8fbd-6908e5c4e34d");
                    // fullwidth full stop
                    break;
                case // halfwidth ideographic full stop
                '\uFF61':
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "68a51284-6827-4e82-8104-36124976b65a");
                    returnValue = ascii + ".";
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "0539b302-d572-43ac-a28c-07bb4ba274d6");
                    break;
                // restore the missing stop
                default:
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "6c90fcea-9614-42b8-9bca-5c1c5c21f312");
                    returnValue = ascii;
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "8c68a487-997f-432b-9402-94b74e48d1d7");
                    break;
            }
        } catch (IllegalArgumentException e) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "6df36d84-5697-43b7-8e3c-ced4d4dc8922");
            // input is not valid
            return input;
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "c247f52f-adfa-4f51-9566-ac60b589b1b6");
        return returnValue;
    }
    ...
    private static boolean isOnlyASCII(String input) {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "13f6b938-8439-444b-891e-ee1403b7b25c");
        if (input == null) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "8ad1dda7-301e-430f-874f-ab4eddf6e618");
            return true;
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "7abd9bae-5347-4d38-a8ea-c7f5a2d705a9");
        for (int i = 0; i < input.length(); i++) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "5b0fe96f-299d-419f-83e3-f0fe17852640");
            if (input.charAt(i) > 0x7F) {
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "d30513eb-574b-427b-bfad-af11037e4523");
                return false;
            }
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "df871343-81f6-456f-a5a6-87386b786be1");
        return true;
    }
    ...
    private static boolean arrayContains(String[] sortedArray, String key) {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_6_10.coverage", "51c6e995-4f72-4ea6-bda3-751867055632");
