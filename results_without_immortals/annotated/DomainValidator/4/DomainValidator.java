...
public class DomainValidator implements Serializable {
    ...
    public static synchronized DomainValidator getInstance() {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "c94d634c-37f5-49a8-b273-0559ba5d418a");
        inUse = true;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "bebd0109-e3e9-4be1-a28c-789a0c73b256");
    ...
    public static synchronized DomainValidator getInstance(boolean allowLocal) {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "d702c168-636b-4c7f-b3cb-e757271bff76");
        inUse = true;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "8c985acd-5b06-48ab-8496-515d45763421");
        if (allowLocal) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "ab3a4d1d-818b-4332-a8a3-d3bdb07f0ebd");
            return DOMAIN_VALIDATOR_WITH_LOCAL;
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "9a6683f5-3c91-43a8-9027-0aefff751bdd");
        return DOMAIN_VALIDATOR;
    }
    ...
    public boolean isValid(String domain) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "5e602575-f0c5-43f1-845d-a461d8426e3f");
        if (domain == null) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "a354e0fb-9642-4c5a-a127-f564946cede2");
            return false;
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "63984380-b24b-4837-94f0-5167bb1f2a0b");
        domain = unicodeToASCII(domain);
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "735f81a8-40c9-4620-8d7c-23d8c2c59eb4");
        // checks in the regexes below
        if (domain.length() > 253) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "ab2f2f05-a627-4ea9-8ab6-b3dbcc2a363c");
            return false;
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "ed7a6bb1-8de5-46e0-8641-9ab5c5a68401");
        String[] groups = domainRegex.match(domain);
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "917a64b6-6fa7-472a-9cd7-13942edc6715");
        if (groups != null && groups.length > 0) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "c1d2e173-632e-4085-b179-1e29811cb654");
            return isValidTld(groups[0]);
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "dd40b06b-f839-4e83-bc92-5619c3a7e004");
    ...
    final boolean isValidDomainSyntax(String domain) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "ac21b646-1f6d-408d-b75a-c8227508287e");
        if (domain == null) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "a441d245-e74f-4179-a089-e9197e79efcf");
            return false;
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "521fcdf3-1ea0-49dd-8e06-9e1d18496a61");
        domain = unicodeToASCII(domain);
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "74bfb1d3-919b-4e7b-aad8-b3eea7e95aa1");
        // checks in the regexes below
        if (domain.length() > 253) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "7000b1a1-c786-4333-8bc6-fb4fec6be258");
            return false;
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "795e330e-a0a4-4a41-b0bc-1fab7fcddcaa");
        String[] groups = domainRegex.match(domain);
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "ceb79291-b07d-4540-8a2b-48f7e6c61eba");
    ...
    public boolean isValidTld(String tld) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "9ab20d1f-0f64-470b-b4c3-517ad55df8f5");
        tld = unicodeToASCII(tld);
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "11cb6e73-a637-4db2-aee7-1f194e2c0d6e");
        if (allowLocal && isValidLocalTld(tld)) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "e30abea7-abf1-474a-8aba-08f42633c630");
            return true;
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "60b841d6-11e9-4428-83e2-0ffb3c082543");
    ...
    public boolean isValidInfrastructureTld(String iTld) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "ebc2ff14-521b-4f0c-81b5-69ceadcd119a");
        final String key = chompLeadingDot(unicodeToASCII(iTld).toLowerCase(Locale.ENGLISH));
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "81619794-a73c-4b98-8e93-7bdb38c9a7f6");
    ...
    public boolean isValidGenericTld(String gTld) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "f8e13381-26af-4ed7-a38e-f5e01698c7c3");
        final String key = chompLeadingDot(unicodeToASCII(gTld).toLowerCase(Locale.ENGLISH));
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "f2439337-970e-41b7-919e-0dc77325346f");
    ...
    public boolean isValidCountryCodeTld(String ccTld) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "55c4b5c5-c03d-4450-8167-8d2414489da1");
        final String key = chompLeadingDot(unicodeToASCII(ccTld).toLowerCase(Locale.ENGLISH));
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "19de5fc4-ac56-4820-989f-b89443949668");
    ...
    public boolean isValidLocalTld(String lTld) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "dc8f6a39-75dd-45e2-b98f-460396f8d439");
        final String key = chompLeadingDot(unicodeToASCII(lTld).toLowerCase(Locale.ENGLISH));
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "3135700c-2d00-42b5-82c9-6139bfb3faaf");
        return arrayContains(LOCAL_TLDS, key);
    }

    private String chompLeadingDot(String str) {
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "351ba50c-3aa4-4e36-aff4-42f4149e2f9e");
        if (str.startsWith(".")) {
            writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "e84477db-df90-4adc-b37b-046b5b7d55ae");
            return str.substring(1);
        }
        writeline("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "d0456365-7a57-4c79-99a5-4f76d699b793");
        return str;
    }
    ...
    static synchronized void clearTLDOverrides() {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "6fe37154-8b31-4719-bcc0-88fee339fbb9");
        inUse = false;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "865b9551-3391-4859-a328-ecee219e2e6d");
        COUNTRY_CODE_TLDS_PLUS = EMPTY_STRING_ARRAY;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "4461718c-d426-4fb1-a187-04557873290e");
        COUNTRY_CODE_TLDS_MINUS = EMPTY_STRING_ARRAY;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "52205878-a72b-4fae-9695-8b176a4c91e6");
        GENERIC_TLDS_PLUS = EMPTY_STRING_ARRAY;
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "38b25dcd-c955-4aaa-8ba1-9a4f1cfd6974");
    ...
    public static synchronized void updateTLDOverride(ArrayType table, String[] tlds) {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "6cbe0171-e0f2-4ed5-8659-7bb45c2198a3");
        if (inUse) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "3a386fed-8971-4cbe-91f3-8f32de10f6bd");
            throw new IllegalStateException("Can only invoke this method before calling getInstance");
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "828fbeee-e027-4aa9-9b98-763f8402a400");
        String[] copy = new String[tlds.length];
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "d21826a4-25a5-43bb-b234-482d1d445217");
        // Comparisons are always done with lower-case entries
        for (int i = 0; i < tlds.length; i++) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "331b8c3c-d51c-40be-8736-566fe2434515");
            copy[i] = tlds[i].toLowerCase(Locale.ENGLISH);
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "da17e9da-17cc-41bb-9a04-1fe0dfd4f7b2");
        Arrays.sort(copy);
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "2aa40620-994e-43a6-8f39-95919b904cf1");
        switch(table) {
            case COUNTRY_CODE_MINUS:
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "8e4df2e7-0abb-4360-841c-f1567ea3b2ee");
                COUNTRY_CODE_TLDS_MINUS = copy;
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "50ea07f5-24bf-402f-a24a-f33e09909f60");
                break;
            case COUNTRY_CODE_PLUS:
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "5492ca3f-3f69-406f-979d-d2bf36a8264b");
                COUNTRY_CODE_TLDS_PLUS = copy;
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "fca2cc78-3da6-4bd5-916c-e2dd1194e919");
                break;
            case GENERIC_MINUS:
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "030de409-d9d7-44c6-bcb2-0d5ad535d20b");
                GENERIC_TLDS_MINUS = copy;
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "2288c017-bec0-400a-adae-cf11a950aa75");
                break;
            case GENERIC_PLUS:
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "d74eaf76-8829-411f-a446-33f331964005");
                GENERIC_TLDS_PLUS = copy;
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "fe999370-8486-4751-b9fc-bd6892d6d472");
                break;
        }
    }
    ...
    static String unicodeToASCII(String input) {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "46ea5436-b5d8-4e9c-93e5-52657de86dbe");
        String returnValue = "";
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "009c3a75-cb5b-47c1-9224-5bcdcaac89d0");
        if (isOnlyASCII(input)) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "73678a67-23a3-4fda-ad0f-a872b0246663");
            // skip possibly expensive processing
            return input;
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "8b5635c8-fff0-4ef8-a3fa-2747c68315b3");
        try {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "4afc0c43-b2d6-4813-9578-5bce77f3e328");
            final String ascii = IDN.toASCII(input);
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "ffd7d022-2c56-41fb-b3e1-2bf0f226232d");
            if (IDNBUGHOLDER.IDN_TOASCII_PRESERVES_TRAILING_DOTS) {
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "7a79a28e-c5e3-4b92-a031-3571bda0e6a2");
                return ascii;
            }
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "697c6c87-2400-4518-9f62-4f4432e1a16c");
            final int length = input.length();
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "6dce121f-2fcf-4a59-99e9-14c06a977c0d");
            if (length == 0) {
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "440f0871-6773-486b-b4da-a94e5b53155c");
                // check there is a last character
                return input;
            }
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "f0d38945-f446-4c43-91eb-7c769cdd8a84");
            // RFC3490 3.1. 1)
            ...
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "70f9245d-9920-45d8-bdd5-f835087a9614");
            switch(lastChar) {
                case '\u002E':
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "2ffb490f-d99d-456b-a057-02e433876fdc");
                    returnValue = ascii + ".";
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "abcc3d7a-6f12-4516-a0ef-c61a39b209ea");
                    // "." full stop
                    break;
                case '\u3002':
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "96221013-ad3f-4637-a175-deae878b9d99");
                    returnValue = ascii + ".";
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "f649a55d-bbcf-4628-9af9-6e92545402c8");
                    // ideographic full stop
                    break;
                case '\uFF0E':
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "f0100888-b38f-48df-8232-ea832a85d7f4");
                    returnValue = ascii + ".";
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "7c9305f8-68cb-4b33-a9fb-7c7c126f22ad");
                    // fullwidth full stop
                    break;
                case // halfwidth ideographic full stop
                '\uFF61':
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "a257a254-56d1-4591-9769-eba6f366e879");
                    returnValue = ascii + ".";
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "70e41045-9067-4814-979c-c81376769d68");
                    break;
                // restore the missing stop
                default:
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "5ae0655f-a53c-4469-8ba6-36e36fa3edeb");
                    returnValue = ascii;
                    writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "5ccff141-f20b-4fed-b948-a7bba2726e2d");
                    break;
            }
        } catch (IllegalArgumentException e) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "b5f621a2-17fd-4c17-8916-6611ea75019e");
            // input is not valid
            return input;
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "fa012aa8-58f3-4102-a21c-b06f9437b97d");
        return returnValue;
    }
    ...
    private static boolean isOnlyASCII(String input) {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "c3a3d132-8ad7-470d-8986-30276a6388d0");
        if (input == null) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "fc923de3-5200-45e2-9078-70cc90791289");
            return true;
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "8002ecb6-8d3b-4858-bec6-04277a9dab52");
        for (int i = 0; i < input.length(); i++) {
            writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "04250961-7f54-4613-8bb6-9f65ad01c6e3");
            if (input.charAt(i) > 0x7F) {
                writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "3012b351-5a49-42ee-8d70-78c608553235");
                return false;
            }
        }
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "f95e8229-f915-44ca-886d-abd06ab741c9");
        return true;
    }
    ...
    private static boolean arrayContains(String[] sortedArray, String key) {
        writelineStatic("/home/ubuntu/results/coverage/DomainValidator/DomainValidator_4_10.coverage", "38ab048e-c280-4483-98aa-e4a1a5f7c58f");
