...
public class StringEscapeUtils {
    ...
    static {
        Map<CharSequence, CharSequence> escapeEcmaScriptMap = new HashMap<CharSequence, CharSequence>();
    ...
    static {
        Map<CharSequence, CharSequence> escapeJsonMap = new HashMap<CharSequence, CharSequence>();
        escapeJsonMap.put("\"", "\\\"");
        escapeJsonMap.put("\\", "\\\\");
        escapeJsonMap.put("/", "\\/");
    ...
    static {
        Map<CharSequence, CharSequence> escapeXml10Map = new HashMap<CharSequence, CharSequence>();
    ...
    static {
        Map<CharSequence, CharSequence> escapeXml11Map = new HashMap<CharSequence, CharSequence>();
    ...
    static {
        Map<CharSequence, CharSequence> escapeXsiMap = new HashMap<CharSequence, CharSequence>();
        escapeXsiMap.put("|", "\\|");
        escapeXsiMap.put("&", "\\&");
        escapeXsiMap.put(";", "\\;");
        escapeXsiMap.put("<", "\\<");
    ...
    static {
        Map<CharSequence, CharSequence> unescapeJavaMap = new HashMap<CharSequence, CharSequence>();
        unescapeJavaMap.put("\\\\", "\\");
        unescapeJavaMap.put("\\\"", "\"");
        unescapeJavaMap.put("\\'", "'");
        unescapeJavaMap.put("\\", "");
