...
public class OntModelImpl extends ModelCom implements OntModel {
    ...
    */
    ...
    public ExtendedIterator<OntClass> listHierarchyRootClasses() {
        return listClasses().filterDrop(new Filter<OntClass>() {
    ...
    public ExtendedIterator<AnnotationProperty> listAnnotationProperties() {
        ...
        if (r == null) {
            ...
            return findByType(r).mapWith(new SubjectNodeAs<AnnotationProperty>(AnnotationProperty.class)).filterKeep(new UniqueFilter<AnnotationProperty>());
        }
    }
