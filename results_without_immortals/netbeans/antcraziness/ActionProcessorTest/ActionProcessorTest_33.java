...
public class ActionProcessorTest extends NbTestCase {
    ...
    public void testWrongPointerToIcon() throws IOException {
        ...
        AnnotationProcessorTestUtils.makeSource(getWorkDir(), "test.A", "import org.openide.awt.ActionRegistration;\n" + "import org.openide.awt.ActionReference;\n" + "import org.openide.awt.ActionID;\n" + "import org.openide.util.actions.Presenter;\n" + "import java.awt.event.*;\n" + "import java.util.List;\n" + "import javax.swing.*;\n" + "@ActionID(category=\"Tools\",id=\"my.action\")" + "@ActionRegistration(displayName=\"AAA\", key=\"K\", iconBase=\"does/not/exist.png\") " + "@ActionReference(path=\"manka\", position=11)" + "public class A implements ActionListener {\n" + "    public void actionPerformed(ActionEvent e) {}" + "}\n");
