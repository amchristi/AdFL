...
public class ActionProcessorTest extends NbTestCase {
    ...
    @ActionReferences({ @ActionReference(path = "Loaders/text/x-my/Actions", id = @ActionID(category = "System", id = "org.openide.actions.OpenAction"), position = 100, separatorAfter = 200) })
    public void testAlwaysEnabledAction() throws Exception {
        ...
        FileObject shad = FileUtil.getConfigFile("My/Folder/D-F6.shadow");
