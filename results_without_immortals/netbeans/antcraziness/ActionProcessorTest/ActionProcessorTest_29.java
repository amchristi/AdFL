...
public class ActionProcessorTest extends NbTestCase {
    ...
    public void testCheckSyntaxInShortcuts() throws IOException {
        clearWorkDir();
        AnnotationProcessorTestUtils.makeSource(getWorkDir(), "test.A", "import org.openide.awt.ActionReference;\n" + "import org.openide.awt.ActionID;\n" + "import java.awt.event.*;\n" + "import org.openide.awt.*;\n" + "import java.awt.event.*;\n" + "@ActionID(category=\"Tools\",id=\"my.action\")" + "@ActionRegistration(displayName=\"AAA\", key=\"K\") " + "@ActionReference(path=\"Shortcuts\", name=\"silly\")" + "public class A implements ActionListener {\n" + "    public void actionPerformed(ActionEvent e) {}" + "}\n");
