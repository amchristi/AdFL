...
public class CallbackSystemActionTest extends NbTestCase {
    ...
    public void testPropertyChangeListenersDetachedAtFinalizeIssue58100() throws Exception {
        ...
        assertEquals("Action is expected to have no PropertyChangeListener attached:\n" + Arrays.asList(action.getPropertyChangeListeners()), 0, action.getPropertyChangeListeners().length);
    }
