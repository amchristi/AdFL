...
public class AlwaysEnabledActionTest extends NbTestCase implements PropertyChangeListener {
    ...
    // NB-Core-Build #3634: Expected to be selected (#2) from testNbPreferences.instance
    @RandomlyFails
    public void testPreferencesAction() throws Exception {
        ...
        // customPreferences() uses "myNode" subnode
        checkPreferencesAction("testCustomPreferences.instance", "user:", Preferences.userRoot());
    }
